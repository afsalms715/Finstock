...
const CardList:React.FC<Props> = ({searchResult,onAddProtfolioSubmit}:Props):JSX.Element => {
    ...
    <div className='flex flex-wrap justify-center w-[100%]'>
        {searchResult.length>0 ?
           searchResult.map((result)=>(
                <Card id={result.symbol} companyData={result} key={uuidv4()} onAddProtfolioSubmit={onAddProtfolioSubmit}/>
           ))
        :
